...
function AnnonceScreen({navigation, detailAnnonce, token}) {
        ...
        <Overlay style={{flex:1}}
                ...
                onBackdropPress={() => {setConfirmation(false)}}>
                    ...
                    <Button 
                        ...
                        onPress = {() => { console.log('monRdv :', monRdv); setConfirmation(false); navigation.navigate('Mes rdv') }} // saveRDV(monRdv)
                        />
            </Overlay>
